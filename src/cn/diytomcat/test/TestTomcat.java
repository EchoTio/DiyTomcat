...
import cn.diytomcat.util.MiniBrowser;
...
public class TestTomcat{
    ...
    public void testTimeConsumeHtml() throws InterruptedException{
        ...
        //尝试关闭线程池，若线程池有任务就不会关闭
        threadpool.shutdown();

        //给线程池一个小时时间去执行，超过一个小时会自动返回，任务结束立即返回
        threadpool.awaitTermination(1,TimeUnit.HOURS);

        //当三个任务结束时候才运行后续代码,获取经过了多长时间毫秒数，并且断言他是超过3秒的

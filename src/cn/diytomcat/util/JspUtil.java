...
public class JspUtil {
    ...
    public static void main(String[] args) {
        try {
            Context context = new Context("/javaweb", "/Users/yangjingbo/IdeaProjects/javaweb/web", null,true);
            File file = new File("/Users/yangjingbo/IdeaProjects/javaweb/web/index.jsp");
